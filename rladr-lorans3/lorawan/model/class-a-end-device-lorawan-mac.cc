...
ClassAEndDeviceLorawanMac::SendToPhy (Ptr<Packet> packetToSend)
{
  ...
  Ptr<LogicalLoraChannel> txChannel = GetChannelForTx ();
        ...
        //**************************tests
    	/*NS_LOG_DEBUG ("Starting Header Removal at ClassA Device Class");
  	    Ptr<Packet> tempkt = packetToSend->Copy();
     	NS_LOG_DEBUG ("Copy of Packet: " << tempkt);
  	    NS_LOG_DEBUG ("Original Packet: " << packetToSend);
        ...
        NS_LOG_DEBUG ("################Size as of ClassA Class #####################  "<< tempkt->GetSize() );
        NS_LOG_DEBUG ("################Content as of ClassA Class ####################  "<< str.str() );
      	*/
...
ClassAEndDeviceLorawanMac::Receive (Ptr<Packet const> packet)
{
  NS_LOG_FUNCTION (this << packet);
	...
	//NS_LOG_DEBUG ("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");   
  	...
  	//NS_LOG_DEBUG ("PacketToSend: " << tempkt);
      	//LorawanMacHeader macHdr;
      	//tempkt->RemoveHeader (macHdr);
      	//LoraFrameHeader frameHdr;
      	//tempkt->RemoveHeader (frameHdr);
	//std::ostream retrv(nullptr);
        ...
        //retrv.rdbuf(&str);
        //tempkt->CopyData(&retrv,tempkt->GetSize());
        //NS_LOG_DEBUG ("#####?&&&&&&###########Size Received on the Phy "<< tempkt->GetSize() );
        //NS_LOG_DEBUG ("#####?&&&&&&###########Content Received on the Phy "<< str.str() );
	//NS_LOG_DEBUG ("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");   
	//NS_LOG_DEBUG ("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");   
      	//ApplyNecessaryOptions (frameHdr);
      	//tempkt->AddHeader (frameHdr);
