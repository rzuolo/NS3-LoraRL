                        ...
                        uint16_t protocol, const Address& address)
{
  ...
  m_controller->OnNewPacket (packet);
    ...
    //**************************tests
    /*    NS_LOG_DEBUG ("Starting Header Removal at NetworkServer Receive Class");
        ...
        NS_LOG_DEBUG ("################Size as of NetworkServer Receive Class #####################  "<< tempkt->GetSize() );
        NS_LOG_DEBUG ("################Content as of NetworkServer  Receive Class ####################  "<< str.str() );
	*/
